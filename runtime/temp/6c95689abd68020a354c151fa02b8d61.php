<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"E:\billgit\brush\public/../application/admin\view\bank_brush\edit.html";i:1606729945;s:59:"E:\billgit\brush\application\admin\view\layout\default.html";i:1588765312;s:56:"E:\billgit\brush\application\admin\view\common\meta.html";i:1588765312;s:58:"E:\billgit\brush\application\admin\view\common\script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<!--    </div>-->
<!--    <div class="form-group">-->
<!--        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Bankno'); ?>:</label>-->
<!--        <div class="col-xs-12 col-sm-8">-->
<!--            <input id="c-bankno" class="form-control" name="row[bankno]" type="text" value="<?php echo htmlentities($row['bankno']); ?>">-->
<!--        </div>-->
<!--    </div>-->
<!--    <div class="form-group">-->
