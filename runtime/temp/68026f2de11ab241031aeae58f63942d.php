...
<script type="text/javascript">
    ...
    <!--    <label class="control-label col-xs-12 col-sm-2"><?php echo __('Orderbrush_id'); ?>:</label>-->
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-orderbrush_id" data-rule="required" data-field="id" data-source="order_brush/index" class="form-control selectpage" name="row[orderbrush_id]" type="text" value="<?php echo htmlentities($row['orderbrush_id']); ?>">-->
    <!--    </div>-->
    <!--</div>-->
    <div class="form-group">
    ...
    <!--</div>-->
    <!--<div class="form-group">-->
    <!--    <label class="control-label col-xs-12 col-sm-2"><?php echo __('Complain_id'); ?>:</label>-->
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-complain_id" data-rule="required" data-field="title" data-source="complain/index" class="form-control selectpage" name="row[complain_id]" type="text" value="<?php echo htmlentities($row['complain_id']); ?>">-->
    <!--    </div>-->
    <!--</div>-->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Say'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-say" class="form-control" name="row[say]" type="text" value="<?php echo htmlentities($row['say']); ?>">
        </div>
    </div>
    <!--<div class="form-group">-->
    ...
    <!--</div>-->
    <!--<div class="form-group">-->
    <!--    <label class="control-label col-xs-12 col-sm-2"><?php echo __('Feed'); ?>:</label>-->
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-feed" data-rule="required" class="form-control" name="row[feed]" type="text" value="<?php echo htmlentities($row['feed']); ?>">-->
    <!--    </div>-->
    <!--</div>-->
